...
void main() {
  group('ScanSnapshotBuilder Hardware Logic', () {
    test('Heuristic spatial streams estimation', () {
      final streams = ScanSnapshotBuilder.estimateSpatialStreams(WifiStandard.ax);
      expect(streams, greaterThanOrEqualTo(2));
    });

    test('BSSID randomization detection (LAA bit)', () {
      expect(ScanSnapshotBuilder.detectBssidRandomization('02:00:00:00:00:00'), isTrue);
      expect(ScanSnapshotBuilder.detectBssidRandomization('00:00:00:00:00:11'), isFalse);
      expect(ScanSnapshotBuilder.detectBssidRandomization('a2:00:00:00:00:00'), isTrue);
    });
