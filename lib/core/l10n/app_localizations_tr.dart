...
class AppLocalizationsTr extends AppLocalizations {
  ...
  String get deepScanExperimentalSubtitle =>
      'Cihazlar ve portlar için LAN\'ı aktif olarak sorgulayın. Artan pil kullanımı.';
  ...
  String get backgroundSelectionRestricted =>
      'Siber ızgara stilleri karanlık mod için optimize edilmiştir ve yalnızca karanlık tema kullanılırken seçilebilir.';
  ...
  String get vulnerabilityOpenNetworkDesc =>
      'Şifreleme tespit edilmedi. Tüm trafik düz metin olarak dinlenebilir.';
  ...
  String get vulnerabilityWepDesc =>
      'WEP kullanımdan kaldırılmıştır ve hızla kırılabilir.';
  ...
  String get vulnerabilityLegacyWpaDesc =>
      'WPA/TKIP daha eskidir ve modern saldırı tekniklerine karşı zayıftır.';
  ...
  String get vulnerabilityHiddenSsidDesc =>
      'Gizli SSID\'ler hala keşfedilebilir ve uyumluluğa zarar verebilir.';

  @override
  String get vulnerabilityHiddenSsidRec =>
      'Tek başına gizli SSID koruma sağlamaz. Güçlü şifrelemeye odaklanın.';
  ...
  String get vulnerabilityWeakSignalDesc =>
      'Zayıf sinyal, kararsız bağlantıları ve yanıltma olasılığını gösterebilir.';
  ...
  String get vulnerabilityWpsDesc =>
      'Wi-Fi Korumalı Kurulum (WPS) etkin. WPS PIN modu, Pixie Dust saldırısı kullanılarak saatler içinde kaba kuvvetle kırılabilir ve şifreyi etkisiz hale getirebilir.';

  @override
  String get vulnerabilityWpsRec =>
      'Yönlendirici yönetici panelinden WPS\'yi devre dışı bırakın. Sadece WPA2/WPA3 parolası kullanın.';
  ...
  String get vulnerabilityPmfDesc =>
      'Bu erişim noktası Korumalı Yönetim Çerçevelerini (PMF / 802.11w) zorunlu tutmuyor. Korunmayan yönetim çerçeveleri, bir saldırganın kimlik doğrulama paketleri oluşturmasına ve istemcilerin bağlantısını kesmesine olanak tanır.';

  @override
  String get vulnerabilityPmfRec =>
      'Yönlendirici ayarlarında PMF\'yi (genellikle \'802.11w\' veya \'Yönetim Çerçevesi Koruması\' olarak adlandırılır) etkinleştirin. WPA3 varsayılan olarak PMF gerektirir.';
  ...
  String get vulnerabilityEvilTwinDesc =>
      'SSID yakında çelişkili güvenlik/kanal parmak iziyle görünüyor.';

  @override
  String get vulnerabilityEvilTwinRec =>
      'Kimlik doğrulama veya veri alışverişinden önce BSSID ve sertifikayı doğrulayın.';
  ...
  String get spectrumOptimizationDesc =>
      'Kanal yoğunluğunu ve paraziti analiz et';
  ...
  String get currentSessionInfo =>
      'Mevcut oturum — yüksek puan = daha az yoğun.';
  ...
  String get rogueApEvidence =>
      'Bilinen ağda Rastgele/LAA MAC algılandı! Bu meşru Erişim Noktaları için oldukça olağandışıdır ve sahte bir cihaza işaret edebilir.';
  ...
  String get deepScanDescription =>
      'Aktif port tarama ve LAN keşfi (Ağ uyarılarını tetikleyebilir)';
  ...
  String get countryAllowlistInfoBody =>
      'Wi-Fi kanalları her ülkede farklı düzenlenir. Bölgenizde yasak olan kanallar soluk gösterilir ve yönlendiricinizde kullanılamaz. Yurt dışındaysanız bölgeyi değiştirebilirsiniz; öneri yalnızca seçilen bölge için yasal kanallar arasından yapılır.';
  ...
  String get runSpeedDoctorDesc =>
      'Speed Doctor\'ı çalıştır — 30 saniyelik kök neden teşhisi.';
  ...
  String get vulnDbFreshMessage =>
      'Bu veritabanına karşı güvenlik açığı aramaları güncel.';

  @override
  String get vulnDbAgingMessage =>
      'Yerel güvenlik açığı veritabanı bir aydan eski. Temiz bir taramanın değeri var ama yakında yenilemeyi düşünün.';

  @override
  String get vulnDbStaleMessage =>
      'Bu veritabanı 90 günden eski. \"Bulgu yok\" sonucu artık ağın güvenli olduğu anlamına gelmiyor — burada henüz temsil edilmeyen çok sayıda yeni CVE olabilir.';
