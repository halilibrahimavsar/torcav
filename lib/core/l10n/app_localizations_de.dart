...
class AppLocalizationsDe extends AppLocalizations {
  ...
  String get vulnerabilityOpenNetworkDesc =>
      'Keine Verschlüsselung erkannt. Der gesamte Datenverkehr kann im Klartext mitgehört werden.';

  @override
  String get vulnerabilityOpenNetworkRec =>
      'Vermeiden Sie sensible Aktivitäten. Bevorzugen Sie ein vertrauenswürdiges VPN oder ein anderes Netzwerk.';
  ...
  String get vulnerabilityWepDesc =>
      'WEP ist veraltet und kann schnell geknackt werden.';

  @override
  String get vulnerabilityWepRec =>
      'Konfigurieren Sie den AP sofort auf WPA2 oder WPA3 um.';
  ...
  String get vulnerabilityLegacyWpaDesc =>
      'WPA/TKIP ist älter und anfälliger für moderne Angriffstechniken.';

  @override
  String get vulnerabilityLegacyWpaRec =>
      'Aktualisieren Sie AP und Clients auf WPA2/WPA3.';
  ...
  String get vulnerabilityHiddenSsidDesc =>
      'Versteckte SSIDs sind weiterhin auffindbar und können die Kompatibilität beeinträchtigen.';

  @override
  String get vulnerabilityHiddenSsidRec =>
      'Eine versteckte SSID allein ist kein Schutz. Konzentrieren Sie sich auf eine starke Verschlüsselung.';
  ...
  String get vulnerabilityWeakSignalDesc =>
      'Ein schwaches Signal kann auf instabile Verbindungen und Anfälligkeit für Spoofing hinweisen.';

  @override
  String get vulnerabilityWeakSignalRec =>
      'Bewegen Sie sich näher zum AP oder validieren Sie die BSSID-Konsistenz.';
  ...
  String get vulnerabilityWpsDesc =>
      'Wi-Fi Protected Setup (WPS) ist aktiviert. Der WPS-PIN-Modus kann innerhalb von Stunden mittels Pixie-Dust-Angriff durch Brute-Force geknackt werden, wodurch jedes Passwort effektiv umgangen wird.';

  @override
  String get vulnerabilityWpsRec =>
      'Deaktivieren Sie WPS im Administrationspanel Ihres Routers. Verwenden Sie ausschließlich eine WPA2/WPA3-Passphrase.';
  ...
  String get vulnerabilityPmfDesc =>
      'Dieser Zugangspunkt erzwingt keine Protected Management Frames (PMF / 802.11w). Ungeschützte Management-Frames ermöglichen es einem Angreifer, Deauthentifizierungspakete zu fälschen und Clients zu trennen.';

  @override
  String get vulnerabilityPmfRec =>
      'Aktivieren Sie PMF in den Router-Einstellungen (oft als \'802.11w\' oder \'Management Frame Protection\' bezeichnet). WPA3 erfordert standardmäßig PMF.';
  ...
  String get vulnerabilityEvilTwinDesc =>
      'Die SSID erscheint in der Nähe mit einem widersprüchlichen Sicherheits-/Kanal-Fingerabdruck.';

  @override
  String get vulnerabilityEvilTwinRec =>
      'Überprüfen Sie BSSID und Zertifikat vor der Authentifizierung oder dem Datenaustausch.';
  ...
  String get failedToSaveHeatmapPoint =>
      'Fehler beim Speichern des Heatmap-Punkts';
  ...
  String get spectrumOptimizationDesc =>
      'Kanalbelegung & Interferenzen analysieren';
  ...
  String get currentSessionInfo =>
      'Aktuelle Sitzung — höhere Punktzahl = weniger überlastet.';
  ...
  String get rogueApEvidence =>
      'Zufällige/LAA-MAC in bekanntem Netzwerk erkannt! Dies ist für legitime Access Points höchst ungewöhnlich und kann auf ein bösartiges Gerät hinweisen.';
  ...
  String get countryAllowlistInfoBody =>
      'WLAN-Kanäle sind länderweise reguliert. In Ihrer Region nicht zugelassene Kanäle werden ausgegraut. Wechseln Sie die Region, wenn Sie im Ausland sind — die Empfehlung zeigt nur legale Kanäle der gewählten Region.';
