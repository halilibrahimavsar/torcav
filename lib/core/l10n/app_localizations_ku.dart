...
class AppLocalizationsKu extends AppLocalizations {
  ...
  String get vulnerabilityOpenNetworkDesc =>
      'Şîfrekirin nehat tespîtkirin. Hemû trafîk wekî nivîs dikare were dîtin.';

  @override
  String get vulnerabilityOpenNetworkRec =>
      'Ji karên hesas dûr bisekin. VPN-ya pêbawer an toreke cuda tercîh bikin.';
  ...
  String get vulnerabilityWepDesc =>
      'WEP nayê pêşniyar kirin û bi hêsanî dikare were şikandin.';

  @override
  String get vulnerabilityWepRec =>
      'Tavilê mîhengên AP biguherînin WPA2 an WPA3.';
  ...
  String get vulnerabilityLegacyWpaDesc =>
      'WPA/TKIP kevn e û li hember êrîşên nûjen lawaz e.';

  @override
  String get vulnerabilityLegacyWpaRec =>
      'AP û amûran bikşînin asteke bilind (WPA2/WPA3).';
  ...
  String get vulnerabilityHiddenSsidDesc =>
      'SSID-yên veşartî hîn jî dikarin werin dîtin û dibe ku lihevhatinê xirab bikin.';

  @override
  String get vulnerabilityHiddenSsidRec =>
      'SSID-ya veşartî ne parastin e. Bala xwe bidin ser şîfrekirina bi hêz.';
  ...
  String get vulnerabilityWeakSignalDesc =>
      'Sînyala lawaz dikare girêdanên ne aram û metirsiyan nîşan bide.';

  @override
  String get vulnerabilityWeakSignalRec =>
      'Nêzîkî AP bibin an BSSID kontrol bikin.';
  ...
  String get vulnerabilityWpsDesc =>
      'Wi-Fi Korumalı Kurulum (WPS) çalak e. Moda PIN-a WPS dikare bi hêsanî were şikandin û gihîştina şîfreyê bide.';

  @override
  String get vulnerabilityWpsRec =>
      'Di panela mîhengan a routerê de WPS bigirin. Tenê WPA2/WPA3 bikar bînin.';
  ...
  String get vulnerabilityPmfDesc =>
      'Ev access point PMF (802.11w) naxwaze. Nivîsên rêvebiriyê yên neparastî rê didin êrîşkaran ku amûran deauth bikin.';

  @override
  String get vulnerabilityPmfRec =>
      'Di mîhengên routerê de PMF (wek \'802.11w\' jî tê zanîn) çalak bikin. WPA3 jixwe PMF dixwaze.';
  ...
  String get vulnerabilityEvilTwinDesc =>
      'SSID li nêzîk bi hûrguliyên ewlehiyê yên nakok xuya dike.';

  @override
  String get vulnerabilityEvilTwinRec =>
      'Beriya nasandinê BSSID û sertîfîkayê kontrol bikin.';
  ...
  String get failedToSaveHeatmapPoint =>
      'Xala nexşeya germiyê nehat tomarkirin';
  ...
  String get spectrumOptimizationDesc =>
      'Qelebalixiya kanalê û parazîtê analîz bike';
  ...
  String get currentSessionInfo =>
      'Oturuma heyî — skora bilind = kêmtir qerebalix.';
  ...
  String get rogueApEvidence =>
      'MAC-a Ketober/LAA di tora naskirî de hat dîtin! Ev ji bo Xalên Gihîştina rewa pir neasayî ye û dibe ku nîşan bide ku amûrek sexte heye.';
  ...
  String get countryAllowlistInfoBody =>
      'Kanalên Wi-Fi li her welatî bi awayekî cuda têne rêvebirin. Kanalên ku li herêma we qedexe ne kêmreng têne nîşandan û ji aliyê routerê we nayên bikaranîn. Heke li derveyê welêt bî, herêmê biguherîne — pêşniyaz tenê kanalên yasayî yên herêma hilbijartî nîşan dide.';
