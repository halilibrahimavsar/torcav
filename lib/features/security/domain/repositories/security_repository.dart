...
abstract class SecurityRepository {
  ...
  Future<Either<Failure, List<TrustedNetworkProfile>>> getTrustedNetworkProfiles();
  ...
  Future<Either<Failure, void>> saveTrustedNetworkProfile(TrustedNetworkProfile profile);
  ...
  Future<Either<Failure, void>> saveAssessmentSession(AssessmentSession session);
  ...
  Future<Either<Failure, List<VulnerableRouter>>> findVulnerabilities(String bssid);
}
